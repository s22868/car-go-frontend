      ...
      <main>
        ...
        <div className="flex flex-col gap-8 px-4 xl:flex-row md:px-8 lg:px-36">
          ...
          <div className="p-5 md:p-8 h-fit rounded-2xl xl:w-1/4 bg-brand-gray-300">
            ...
            <div className="flex items-center w-full px-6 text-lg font-semibold md:text-2xl h-14 bg-brand-gray-400 rounded-2xl text-brand-gray-100">
              {user?.balance || 0} PLN
            </div>
            <div className="flex flex-col gap-6 mt-6">
              <Button className='text-sm md:text-base' onClick={() => setIsWithdrawModalOpen(true)}>
                Wypłać
              </Button>
              <Button className='text-sm md:text-base' variant="secondary" onClick={() => setIsModalOpen(true)}>
                Wpłać
              </Button>
            </div>
          </div>
